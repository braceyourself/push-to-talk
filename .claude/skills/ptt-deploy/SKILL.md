...
1. **Diff check** — Show which files differ between repo and deploy:
   ...
   changed=()
   for f in push-to-talk.py indicator.py live_session.py input_classifier.py learner.py task_manager.py task_tools_mcp.py pipeline_frames.py clip_factory.py stream_composer.py response_library.py openai_realtime.py deepgram_stt.py ptt-launcher.py dashboard.py category_exemplars.json vocabulary.txt requirements.txt; do
