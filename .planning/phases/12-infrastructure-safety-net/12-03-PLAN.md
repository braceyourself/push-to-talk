...
must_haves:
  truths:
    ...
    - "All transcripts during active playback AND cooldown period are suppressed (playback gating is intentionally aggressive -- echo filtering provides defense-in-depth for any leakthrough after cooldown expires)"
  artifacts:
